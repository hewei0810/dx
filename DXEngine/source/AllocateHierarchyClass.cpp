	...
	*ppNewMeshContainer = NULL;
	...
	if( NumMaterials > 0 )
	{
		...
		for( iMaterial = 0; iMaterial < NumMaterials; iMaterial++ )
		{
			...
			{
				CStdString strTmp = CGlobalManager::GetManager()->GetResPath() + pMeshContainer->pMaterials[iMaterial].pTextureFilename;
				if( FAILED( D3DXCreateTextureFromFileA( pd3dDevice, strTmp.GetData(),
